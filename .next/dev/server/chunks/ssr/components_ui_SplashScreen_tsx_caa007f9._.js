...
function SplashScreen({ onComplete }) {
    ...
    const [isPreloaded, setIsPreloaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // Memoized timings for consistent animation sync
    const animationTimings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            logoDelay: 300,
    ...
    const preloadResources = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const totalSteps = 25;
            for(let i = 0; i <= totalSteps; i++){
                await new Promise((resolve)=>setTimeout(resolve, animationTimings.progressInterval));
...
//# sourceMappingURL=components_ui_SplashScreen_tsx_caa007f9._.js.map