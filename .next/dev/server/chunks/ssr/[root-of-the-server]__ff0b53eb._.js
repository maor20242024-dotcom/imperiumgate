...
const loadAllProjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>{
    ...
    PROJECT_CACHE_TAGS.ALL_PROJECTS
], {
    tags: [
        PROJECT_CACHE_TAGS.ALL_PROJECTS
    ],
...
const getProjectBySlug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async (developerSlug, projectSlug)=>{
    console.log(`🔄 Loading project ${developerSlug}/${projectSlug} (cache miss)`);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$unifiedDataService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProjectBySlug"])(developerSlug, projectSlug);
    return result || null;
}, [
...
const getProjectsByDeveloper = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async (developerSlug)=>{
    console.log(`🔄 Loading projects for developer ${developerSlug} (cache miss)`);
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$unifiedDataService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProjectsByDeveloper"])(developerSlug);
}, [
...
async function getAllDeveloperParams() {
...
async function getAllProjectParams() {
    const allProjects = await loadAllProjects();
    const params = [];
    allProjects.forEach((project)=>{
        const developerSlug = typeof project.developer === 'string' ? project.developer : project.developer?.slug;
