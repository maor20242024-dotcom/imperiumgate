...
function Filters({ initial }) {
    ...
    const devRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const bedsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Filters.useEffect": ()=>{
            const handleClickOutside = {
                "Filters.useEffect.handleClickOutside": (event)=>{
                    if (devRef.current && !devRef.current.contains(event.target)) {
                        setShowDevDropdown(false);
                    }
                    if (bedsRef.current && !bedsRef.current.contains(event.target)) {
            ...
            }["Filters.useEffect.handleClickOutside"];
            document.addEventListener('mousedown', handleClickOutside);
            return ({
                "Filters.useEffect": ()=>document.removeEventListener('mousedown', handleClickOutside)
            })["Filters.useEffect"];
        }
    }["Filters.useEffect"], []);
...
_s(Filters, "w6yOAMpniTR49g24Yus1BXyXKlg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"]
    ];
});
