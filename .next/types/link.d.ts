...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/${SafeSlug<T>}/admin`
    | `/${SafeSlug<T>}/ai`
    | `/${SafeSlug<T>}/ai/assistant`
    | `/${SafeSlug<T>}/ai/invest-advice`
    | `/${SafeSlug<T>}/ai/map`
    | `/${SafeSlug<T>}/ai/personalized-projects`
    | `/${SafeSlug<T>}/compare`
    | `/${SafeSlug<T>}/contact`
    | `/${SafeSlug<T>}/developers`
    | `/${SafeSlug<T>}/developers/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/developers/${SafeSlug<T>}/communities`
    | `/${SafeSlug<T>}/developers/${SafeSlug<T>}/communities/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/developers/${SafeSlug<T>}/projects`
    ...
    | `/${SafeSlug<T>}/terms`
    | `/${SafeSlug<T>}/vision`
    | `/api/projects/${SafeSlug<T>}/units`
    | `/api/public-data/${SafeSlug<T>}`
    | `/api/public-data/${SafeSlug<T>}/communities`
    | `/api/public-data/${SafeSlug<T>}/communities/${SafeSlug<T>}`
